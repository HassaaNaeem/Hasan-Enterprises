...
router.post('/:plotId/documents', protect, authorize('purchaser'), uploadFields, uploadPlotDocuments);
router.put('/:plotId/verify', protect, authorize('service_provider', 'admin'), verifyPlotDocuments);
